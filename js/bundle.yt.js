...
window.Ytrends = function a(geoLocation,parseCreatorOnRise,page)
{ 
    return new Promise((resolve, reject) => {
        var parameters = {
            geoLocation: geoLocation,
            parseCreatorOnRise: parseCreatorOnRise,
            page: page
        }
...
},{"@freetube/yt-trending-scraper":3}],3:[function(require,module,exports){
 module.exports = require("./src/Youtube-Scraper")

},{"./src/Youtube-Scraper":5}],4:[function(require,module,exports){
const axios = require("axios")
const trendingPageBase = "http://sbcors.herokuapp.com/https://youtube.com/feed/trending"
const pageAdditions = {
...
},{"./TrendingRequester":4}],6:[function(require,module,exports){
